# Generated by Django 5.2.14 on 2026-05-06 13:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_email', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='responses', to='mailapp.email')),
                ...
                ('starred_by', models.ManyToManyField(blank=True, related_name='starred_emails', to=settings.AUTH_USER_MODEL)),
                ('thread_root', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='thread_messages', to='mailapp.email')),
            ],
            options={
                'ordering': ['-updated_at'],
            },
